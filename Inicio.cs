...
namespace CapaPresentacion
{
    public partial class Inicio : Form
    {
        ...
        private void SubMenuRepCompras_Click(object sender, EventArgs e)
        {
            AbrirFormulario(menureportes, new FormReporteCompras());
        }

        private void SubMenuRepVentas_Click(object sender, EventArgs e)
        {
            AbrirFormulario(menureportes, new FormReporteVentas());
        }
        private void menuacercade_Click_1(object sender, EventArgs e)
        {
